...
§
        ...
        */
        ...
        echo "<b>Positive tags most associated with agreeableness: </b>";
        echo "<br><br>";
        echo "teacher,wedding,space,NASA,moon,Nudity (Full Frontal),New York City,controversial,India,England,show business,radio,voyeurism,imdb top 250,Alfred Hitchcock,Hollywood,indiana jones,ark of the covenant,archaeology,zither,Venice,ferris wheel,Civil War,POW,spying,memory,survival,High School,island,lawn mower,brothers,dance marathon,Graham Greene,circus,big top,journalism,Tennessee Williams,sexuality,samurai,women,sisterhood,Lou Gehrig,baseball,Girl Power,salute to Douglas Sirk,music business,Dickens,Stones of Summer,books,lions,animal movie,Titanic,Renee Zellweger,Ewan McGregor,child abuse,terminal illness,Amish,In Netflix queue,mountain climbing,multiple personalities,cancer,MacBeth,Nick and Nora Charles,Oscar (Best Actress),abortion,made me cry,fatherhood,revenge,boxing,Shakespeare,Firefly,PTSD,paranoia,Insanity,creepy,conspiracy theory,based on a play,quirky,mental illness,introspection,Eccentric,black comedy,adorable,high school,funny,dreamlike,atmospheric";
        echo "<br><br>";

        echo "<b>Positive tags most associated with emotional stability: </b>";
        echo "<br><br>";
        echo "time travel,remake,post-apocalyptic,Post apocalyptic,mindfuck,Bruce Willis,Brad Pitt,sword fight,revenge,Oscar (Best Cinematography),mel gibson,Medieval,inspirational,historical,epic,beautiful scenery,infertility,France,basketball,Ireland,radio,India,Atomic bomb,dark comedy,black comedy,movie business,space,Hal,politics,indiana jones,ark of the covenant,archaeology,Conan,president,Henry James,police,theater,Vietnam,show business,1920s,Christmas,drug abuse,death penalty,preacher,von Bulow,hippies,reciprocal spectator,boxing,Holocaust,violent,sequel,spoof,obsession,gangs,Titanic,gambling,religion,Watergate,journalism,Deep Throat,Dickens,prison,birds,men in drag,cross dressing,adultery,swashbuckler,Australia,made me cry,lesbian,drugs,Shakespeare,Firefly,In Netflix queue,Animal movie,undercover cop,twist ending,suspense,Leonardo DiCaprio,Martin Scorsese,Jack Nicholson,atmospheric,PTSD,paranoia,Insanity,creepy,conspiracy theory,based on a play,Steve Carell,Anne Hathaway,fantasy,adventure,music,indie record label,britpop,animation,understated,sweet,quirky,visually appealing,thought-provoking,smart,good cinematography,cinematography,Cerebral,beautiful visuals";
        echo "<br><br>";

        echo "<b>Positive tags most associated with conscientiousness: </b>";
        echo "<br><br>";
        echo "serial killer,Mark Wahlberg,Leonardo DiCaprio,heroin,addiction,sci-fi,action,great soundtrack,EPIC,Star Wars,oldie but goodie,space opera,luke skywalker,darth vader,atmospheric,Coen Brothers,statue,Russia,Cold War,Politics,John Grisham,time travel,Shakespeare,Conan,Hungary,Holocaust,fatherhood,writing,subway,Pearl S Buck,1920s,von Bulow,movie business,Oscar Wilde,World War I,race,motherhood,spoof,In Netflix queue,children,gambling,anime,movies,multiple roles,family,murder,death penalty,crime,Capote,black and white,surfing,big wave,cattle drive,amnesia,memory,love,Jim Carrey,imagination,cult film,Nick and Nora Charles,swashbuckler,Anne Boleyn,gold,made me cry,India,genocide,lyrical,Steve Carell,Anne Hathaway,solitude,Sci-fi,2001-like,surreal,philosophy,Adam Sandler,silly,ridiculous,funny,visually appealing,thought-provoking,smart,good cinematography,cinematography,Cerebral,beautiful visuals";
        echo "<br><br>";

        echo "<b>Positive tags most associated with extraversion: </b>";
        echo "<br><br>";
        echo "teacher,high school,England,muppets,Made me cry,infertility,France,basketball,action,great soundtrack,EPIC,Star Wars,oldie but goodie,space opera,luke skywalker,darth vader,journalism,large cast,voyeurism,divorce,fugitive,Hemingway,race,Disney,Shakespeare,NASA,Holy Grail,archaeology,E. M. Forster,lawyer,Shark,TV,Henry James,Judaism,anti-Semitism,S.E. Hinton,murder,heist,Hungary,workplace,stapler,Nicolas Cage,Star Trek,remade,Australia,a dingo ate my baby,sexuality,transplants,1920s,business,court,missing children,factory,invisibility,Quakers,psychopaths,Tennessee Williams,death penalty,Christmas,Nabokov,Union,accident,social commentary,no dialogue,imagination,free to download,dystopia,creativity,claymation,family,movie business,boxing,sequel,first was much better,crappy sequel,Oscar Wilde,teenagers,widows/widowers,planes,violence,photography,crime,ghosts,South America,politics,Chile,Stones of Summer,books,sci-fi,anime,amazing artwork,gangs,Ray Bradbury,Civil War,religion,violence in america,adolescence,inhumane,haunting,harsh,disturbing,confrontational,bleak,Astaire and Rogers,prison,birds,E.M. Forster,Holocaust,marriage,deaf,blindness,space station,sports,Hepburn and Tracy,adultery,swashbuckler,assassination,Oscar (Best Actress),biopic,martial arts,revenge,show business,made me cry,donkey,lesbian,drugs,genocide,motherhood,pregnancy,bears,Animal movie,Dickens,In Netflix queue,courtroom drama,twist ending,Paul Giamatti,M. Night Shyamalan,far fetched,fairy tale,faerie tale,disappointing,bad,superhero,space,Ryan Reynolds,DC Comics,DC,comic book,cheesy,CGI,audience intelligence underestimated,music,indie record label,britpop,interesting scenario,unnecessary sequel,Turkey,predictable,Liam Neeson,Istanbul,suspense,ryan reynolds,immortality,ethics,Ben Kingsley,tragic,thought-provoking,philosophical,contemplative";
        echo "<br><br>";
